...
// This function exists to create M left children from the main process.
void create_n_child_processes(int m) {
    if (m == 0) {
        return;
    }
